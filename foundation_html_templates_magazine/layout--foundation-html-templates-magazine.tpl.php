...
<div class="layout--foundation-html-templates-magazine container <?php print implode(' ', $classes); ?>"<?php print backdrop_attributes($attributes); ?>>
  <div id="skip-link">
    <a href="#main-content" class="element-invisible element-focusable"><?php print t('Skip to main content'); ?></a>
  </div>

  <?php if ($content['header']): ?>
    <header class="l-header top-bar" role="navigation" aria-label="<?php print t('Site header'); ?>">
  ...
  <?php if ($content['top']): ?>
    <header class="l-top medium-4 columns" role="banner" aria-label="<?php print t('Site logo'); ?>">
      <?php print $content['top']; ?>
    </header>
  <?php endif; ?>

  <?php if ($content['top_second']): ?>
    <header class="l-top l-top-second medium-8 columns" role="note" aria-label="<?php print t('Site second level menu'); ?>">
      <?php print $content['top_second']; ?>
    </header>
  <?php endif; ?>
  </div>

  <?php if ($content['header_second']): ?>
    <header class="l-header-second top-bar container" role="menu" aria-label="<?php print t('Site third level menu'); ?>">
  ...
  <main class="container row" role="main" aria-label="<?php print t('Main content'); ?>">
    ...
    <?php if ($content['sidebar_first']): ?>
        <aside class="l-sidebar sidebar-first container featured medium-4 columns" role="complementary" aria-label="<?php print t('Complementary information'); ?>">
  ...
  <?php if ($content['big_statement_second']): ?>
      <section class="l-big-statement-second container large-8 columns" role="region">
        <?php print $content['big_statement_second']; ?>
      </section>
  <?php endif; ?>

  <?php if ($content['sidebar_second']): ?>
        <aside class="l-sidebar sidebar-second container large-4 columns" role="complementary" aria-label="<?php print t('Complementary information'); ?>">
  ...
  <?php if ($content['footer_action']): ?>
    <footer class="l-footer-action container row column expanded callout secondary" role="secondary" aria-label="<?php print t('Action to take'); ?>">
      <?php print $content['footer_action']; ?>
    </footer>
  <?php endif; ?>

  <?php if ($content['footer']): ?>
    <footer class="l-footer container row column expanded" role="contentinfo" aria-label="<?php print t('Footer navigation'); ?>">
